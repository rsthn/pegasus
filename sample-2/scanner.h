...
const int symbol = 259;
	...
	class Scanner
	{
		...
		protected: Token *translate (Token *token)
		{
            ...
            {
                if (token->equals("print")) { return token->setType(256); }
...
switch (state)
{
    case 1:
        ...
        switch (symbol)
        {
            ...
            case 40: case 41: case 59: case 60: case 61: case 62: state = 11; shift = 1; break;
    ...
    case 6:
        switch (symbol)
        {
            case 48: case 49: case 50: case 51: case 52: case 53: case 54: case 55: case 56: case 57: case 95: state = 16; shift = 1; break;
        }
