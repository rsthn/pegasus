	...
	*/
	class FileDataProvider : public IDataProvider
	{
		...
		*/
		...
		{
			return this->fp == NULL ? -1 : getc (this->fp);
		}
	};
	...
	*/
	class Token
	{
		...
		*/
		...
		{
			if (item == NULL || item->type != type || item->length != length)
				return false;
		...
		*/
		...
		{
			if (value == NULL || (int)strlen(value) != length)
				return false;
		...
		*/
		bool equals (int type, char *value=NULL)
		{
			if (this->type != type || (value != NULL && (int)strlen(value) != this->length))
				return false;

			return value == NULL ? true : !memcmp (this->value, value, length);
		}
	...
	class Scanner
	{
		...
		*/
		protected: Token *translate (Token *token)
		{
            ...
            {
                if (token->equals("hello")) { return token->setType(256); }
                if (token->equals("world")) { return token->setType(256); }
            }
...
switch (state)
{
    case 1:
        ...
        switch (symbol)
        {
            ...
            case 59: case 97: case 98: case 99: case 100: case 101: case 102: case 103: case 104: case 105: case 106: case 107: case 108: case 109: case 110: case 111: case 112: case 113: case 114: case 115: case 116: case 117: case 118: case 119: case 120: case 121: case 122: state = 7; shift = 1; break;
            case 9: case 10: case 13: case 32: state = 8; shift = 1; break;
        }
    ...
    case 5:
        switch (symbol)
        {
            case 59: case 97: case 98: case 99: case 100: case 101: case 102: case 103: case 104: case 105: case 106: case 107: case 108: case 109: case 110: case 111: case 112: case 113: case 114: case 115: case 116: case 117: case 118: case 119: case 120: case 121: case 122: state = 11; shift = 1; break;
        }
